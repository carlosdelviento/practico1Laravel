...
<div class="row">
    ...
    <div class="col-sm-12 col-md-8">
        <div class="form-group">
            <label>Código</label>
            <input type="text" wire:model.lazy="barcode" class="form-control" placeholder="ej: 020245">
            @error('barcode')
                <span class="text-danger er">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-sm-12 col-md-8">
        <div class="form-group">
            <label>Stock</label>
            <input type="number" data-type='currency' wire:model.lazy="stock" class="form-control"
                placeholder="ej: 0">
            @error('stock')
                <span class="text-danger er">{{ $message }}</span>
            @enderror
    ...
    <div class="col-sm-12 col-md-8">
        <div class="form-group">
            <label>Alertas</label>
            <input type="number" data-type='currency' wire:model.lazy="alerts" class="form-control"
                placeholder="ej: 10">
            @error('alerts')
                <span class="text-danger er">{{ $message }}</span>
            @enderror
